...
class _TestScreenState extends State<TestScreen> {
  ...
  Future<void> _onImageButtonPressed(ImageSource source,
    ...
    if (isVideo) {
      ...
      XFile outputFile = XFile("${tempDir.path}/modified.mp4");
      addTextOnVideo(file!.path, outputFile.path, "test").then((sessionFuture) => {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(title: "Video Player"),
      body: Center(
